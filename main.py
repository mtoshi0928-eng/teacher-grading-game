...
# 模範解答専用フォント（0.7倍）
font_model_sub = get_safe_font(10)   # 模範解答の番号やヘッダー文字用 (14 * 0.7)
font_model_ans = get_safe_font(21)   # 模範解答の赤文字用 (30 * 0.7)
    ...
    while True:
        ...
        # --- ② PLAY ---
            ...
            for t_idx, t_char in enumerate(title_str):
                model_sheet.blit(font_model_sub.render(t_char, True, (120, 120, 120)), (470, 45 + t_idx * 18))
            model_sheet.blit(font_model_sub.render("番", True, (120, 120, 120)), (430, 52))
            model_sheet.blit(font_model_sub.render("名前", True, (120, 120, 120)), (423, 145))
            model_sheet.blit(font_model_sub.render("点", True, (120, 120, 120)), (430, 255))
            ...
            for idx in range(10): 
                ...
                num_str = f"({prob['num']})"
                model_sheet.blit(font_model_sub.render(num_str, True, (120, 120, 120)), (box_rect.x + 10, box_rect.y - 16))
                ...
                start_x_offset = box_rect.width // 2 - 10       

                for g_idx, g_char in enumerate(prob["model_ans"]):
                    model_sheet.blit(font_model_ans.render(g_char, True, (220, 50, 50)), (box_rect.x + start_x_offset, box_rect.y + start_y_offset + g_idx * spacing))
        ...
        # --- ③ RESULT ---
            ...
            if not show_wrong_matrix:
                ...
                if len(history_marked_sheets) == 0:
                    ...
                    title_str = "ひらがなテスト"
                    for t_idx, t_char in enumerate(title_str):
                        rev_model_sheet.blit(font_model_sub.render(t_char, True, (120, 120, 120)), (470, 45 + t_idx * 18))
                    rev_model_sheet.blit(font_model_sub.render("番", True, (120, 120, 120)), (430, 52))
                    rev_model_sheet.blit(font_model_sub.render("名前", True, (120, 120, 120)), (423, 145))
                    rev_model_sheet.blit(font_model_sub.render("点", True, (120, 120, 120)), (430, 255))
                    ...
                    for idx in range(10):
                        ...
                        rev_model_sheet.blit(font_model_sub.render(num_str, True, (120, 120, 120)), (box_rect.x + 10, box_rect.y - 16))
                        ...
                        for g_idx, g_char in enumerate(h_prob["model_ans"]):
                            rev_model_sheet.blit(font_model_ans.render(g_char, True, (220, 50, 50)), (box_rect.x + start_x_offset, box_rect.y + start_y_offset + g_idx * spacing))
